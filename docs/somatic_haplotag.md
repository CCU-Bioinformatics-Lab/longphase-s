...
- [SNV and INDEL somatic haplotagging](#snv-and-indel-somatic-haplotagging)
...
- [Output files](#output-files)
  - [Tagged tumor BAM file](#tagged-tumor-bam-file)
...
This command performs tumor purity estimation and somatic variant calling using tumor-normal pair BAM files, then tags (assigns) each read in tumor BAM to one haplotype based on phased normal SNP VCF and tumor SNP VCF. See [Input Preparation](../README.md#input-preparation) for details on how to prepare the required input files:
- Reference genome: [Generate reference index](./input_preparation.md#generate-reference-index)
- BAM files: [Generate alignment and index files](./input_preparation.md#generate-alignment-and-index-files)
- Phased normal SNP VCF: [Generate germline SNP file](./input_preparation.md#generate-germline-snp-vcf-file) and then perform [phasing](./phase.md#snp-only-phasing)
- Tumor SNV VCF: [Generate somatic SNV file](./input_preparation.md#generate-somatic-snp-vcf-file)
