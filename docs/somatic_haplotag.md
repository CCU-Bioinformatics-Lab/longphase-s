...
- [SNP-only somatic haplotag](#snp-only-somatic-haplotag)
- [Somatic haplotagging benchmark](#somatic-haplotagging-benchmark)
- [The complete list of somatic haplotag parameter](#the-complete-list-of-somatic-haplotag-parameters)
- [Ouputfiles](#output-files)
  - [Tumor purity prediction result file](#tumor-purity-prediction-result-file)
...
This command performs tumor purity prediction and somatic variant calling, then tags (assigns) each read in tumor BAM to one haplotype based on phased normal SNP VCF and tumor SNP VCF. The reads will be tagged as:
...
1. Prerequisite:
   - Assumes accurate germline SNP phasing (HP tags)

2. Read-level comparison:
   - Truth somatic reads: All reads containing true somatic variants from truth VCF
   - Program-tagged somatic reads: Reads classified as somatic by the program (with tags H1-1, H2-1, or H3)
...
4. Performance metrics:
   - Precision, Recall, and F1-Score for each haplotype (H1-1, H2-1, H3)
...
### The complete list of somatic haplotag parameters
---
```
...
### Output files
---
### Tumor purity prediction result file
The tumor purity prediction reuslt file contains the estimated tumor purity value and related statistics. The file includes:
- Tumor purity: The estimated tumor purity value (0.0-1.0)
- Filter parameters: Parameters used for filtering the prediction data
- Data size: Number of variants used for prediction

An example of tumor purity prediction file
```
#==========Prediction result===========
...
1. Additional header information:
   - LongPhase-S version
   - Command line used for analysis
...
##commandline=longphase_s somatic_haplotag -s normal_phased.vcf -b normal.bam --tumor-snp-file 
...
3. Detailed read information:
   ...
   - Assigned haplotype
   - Truth variant position and assigned haplotype
...
##Tatal reads: 216335
##Tatal truth somatic reads: 4756
##Tatal truth H1-1: 2124
##Tatal truth H2-1: 2349
##Tatal truth H3: 283
## Haplotype   Precision      Recall         F1-Score       TP             FP             FN             
##-----------------------------------------------------------------------------------------------
## H1-1        0.9818         0.6083         0.7512         1292           24             832            
## H2-1        0.9753         0.6718         0.7956         1578           40             771            
## H3          0.9907         0.3781         0.5473         107            1              176            
##-----------------------------------------------------------------------------------------------
## Overall     0.9786         0.6259         0.7635         2977           65             1779           
##
...
chr20   SRR25005626.3581193     1.0000  0.0000  25      1       H2-1    458445,3        
chr20   SRR25005626.11585798    0.9688  0.0000  32      1       H2-1    458445,3        
chr20   SRR25005626.318725      1.0000  0.0000  18      1       H2-1    458445,3        
chr20   SRR25005626.17800558    1.0000  0.0000  36      1       H2-1    458445,3
```