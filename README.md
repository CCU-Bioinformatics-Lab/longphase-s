# LongPhase-S
LongPhase-S is a program for somatic variant haplotagging and tumor purity prediction from tumor-normal pair long-read sequencing data. It also supports germline variant phasing and haplotagging, and is based on [**LongPhase**](https://github.com/twolinin/longphase) (v1.7.3).
