...
![workflow](./images/somatic_tagging_workflow_2.0.png)
...
![INDEL performance (original cell line)](./images/indel_comparison_clairS_ssrs_deepSomatic_1.0_orig_bam.png)
...
![INDEL performance (varying tumor purity and cell lines)](./images/indel_performance_varying_purity.png)
...
![haplotagging IGV case](./images/somatic_tagging_IGV_case_2.0.png)
...
- [Usage](#usage)
  - [**Somatic mode**](#somatic-mode)
	- [Somatic haplotagging command](#somatic-haplotagging-command)
		- [SNP and INDEL somatic haplotagging](./docs/somatic_haplotag.md#snp-only-somatic-haplotagging)
...
This command performs tumor purity estimation and somatic variant calling using tumor-normal pair BAM files, then tags (assigns) each read in tumor BAM to one haplotype based on phased normal SNP VCF and tumor SNP VCF. See [Input Preparation](#input-preparation) for details on how to prepare the required input files:
- Reference genome: [Generate reference index](./docs/input_preparation.md#generate-reference-index)
- BAM files: [Generate alignment and index files](./docs/input_preparation.md#generate-alignment-and-index-files)
- Phased normal SNP VCF: [Generate germline SNP file](./docs/input_preparation.md#generate-germline-snp-vcf-file) and then perform [phasing](./docs/phase.md#snp-only-phasing)
- Tumor SNV VCF: [Generate somatic SNV file](./docs/input_preparation.md#generate-somatic-snp-vcf-file)
...
[See detailed DeepSomatic output support documentation](./docs/phase.md#deepsomatic-output-support)
...
- [Generate alignment and index files](./docs/input_preparation.md#generate-alignment-and-index-files)
- [Generate germline SNP file](./docs/input_preparation.md#generate-germline-snp-vcf-file)
- [Generate somatic SNV file](./docs/input_preparation.md#generate-somatic-snp-vcf-file)
...
1. Generate tumor SNV VCF using [somatic variant callers](./docs/input_preparation.md#generate-somatic-snp-vcf-file)
